...
napi_value create_fn;
	...
	// Phase 2 of issue #28: Fenger-Toeplitz recovery variant. Bit-exact
	// alternative to compute_recovery_full on power-of-2 inputs/recovery
	// counts; falls back to the legacy muladd path otherwise.
