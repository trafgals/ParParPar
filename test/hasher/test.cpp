...
bool do_ihasher_tests(IHasherInput* hasher) {
	...
	// cubic review on PR #123 P2: zero-length updateFile must NOT reset pending block
	ADD_DATA(updateFile, "")
	CHECK_BLOCK("\x0c\xc1\x75\xb9\xc0\xf1\xb6\xa8\x31\xc3\x99\xe2\x69\x77\x26\x61", 0xe8b7be43, "zero-len updateFile preserves pending block")
