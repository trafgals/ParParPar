...
var binding = null;
try {
	binding = require('../build/Release/parpar_gf.node');
} catch(e) {
	try {
		binding = require('./parpar_gf.node');
	} catch(e2) {
		// Native addon not built; will throw if native methods are invoked
	}
}
...
var getMethodNum = function(col, method) {
	...
	// null, undefined, 'auto', or '' -> default (index 0)
	if(method === null || method === undefined || method === 'auto' || method === '')
		return 0;
