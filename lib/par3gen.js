...
try {
	...
	// blake3 npm package not installed; will throw when hashing methods are invoked
}
...
var friendlySize = utils.friendlySize;
var friendlyCount = utils.friendlyCount;
var sumSize = utils.sumSize;
var pathNormalize = utils.pathNormalize;
var pathToPar3 = utils.pathToPar;
...
function fileInfo(files, recurse, skipSymlinks, concurrency, cb) {
	return require('./filescan').fileScan(files, recurse, skipSymlinks, concurrency, 'sha256', cb);
}
