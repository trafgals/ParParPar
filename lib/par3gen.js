...
run: function(eventCb, completeCb) {
	...
	global.__par3ProfStart('setup');
		...
		var hasAccumulate = bindingRef && typeof bindingRef.compute_recovery_accumulate === 'function';

		// cubic review df1de4cb P1: keep Fenger out of useChunkedCreate until Fenger has bounded-memory implementation
		var useChunkedCreate = !disableChunked && hasAccumulate && routingDecision.kernel !== 'fenger' &&
