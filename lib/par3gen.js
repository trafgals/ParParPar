...
function dispatchRecovery(binding, inputs, outputs, numInputs, numRecovery, blockSize, firstInput, firstRecovery, numThreads, fallbackFn) {
	...
	var fengerEnabled = useFengerEnv === '1' || useFengerEnv === 'true' || useFengerEnv === 'yes' || useFengerEnv === 'on';
	...
	if(fengerEnabled) {
		...
		var fengerEligible = _isPowerOfTwoOrTrivial(numInputs) && _isPowerOfTwoOrTrivial(numRecovery);
		if(fengerEligible) {
