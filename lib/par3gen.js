...
function fileInfo(files, recurse, skipSymlinks, concurrency, cb) {
	...
	scanFiles = function(files, recurse, cbDoneScan) {
		...
		// cubic review 59dd8dd8 P2: bounded parallel file scanning via eachOfLimit preserving input ordering
		async.eachOfLimit(files, concurrency, function(file, fileIdx, cbNextFile) {
