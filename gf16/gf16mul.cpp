...
# include "x86_jit.h"
struct GF16CpuCap {
	bool hasSSE2, hasSSSE3, hasAVX, hasAVX2, hasAVX512VLBW, hasAVX512VBMI, hasGFNI, hasBMM;
	  ...
	  jitOptStrat(GF16_XOR_JIT_STRAT_NONE)
	{
		...
		hasAVX = false; hasAVX2 = false; hasAVX512VLBW = false; hasAVX512VBMI = false; hasGFNI = false; hasBMM = false;
...
Galois16Methods Galois16Mul::default_method(size_t regionSizeHint, unsigned inputs, unsigned /*outputs*/, bool forInvert) {
	...
	if(gf16_affine_available_bmm && caps.hasBMM && caps.hasAVX512VLBW)
		return GF16_AFFINE_BMM;
	if(caps.hasGFNI) {
