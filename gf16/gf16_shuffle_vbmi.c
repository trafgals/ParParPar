...
static HEDLEY_ALWAYS_INLINE void gf16_shuffle_muladd_x_vbmi(
	...
	for(intptr_t ptr = -(intptr_t)len; ptr; ptr += sizeof(__m512i)*2) {
		...
		if(srcCount > 1) {
			...
			tph = _mm512_ternarylogic_epi32(tph, th, _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale)), 0x96);
			tpl = _mm512_ternarylogic_epi32(tpl, tl, _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale) + 1), 0x96);
		} else {
			th = _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale));
			tl = _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale) + 1);
		}
		...
		_mm512_storeu_si512((__m512i*)(_dst1+ptr*dstScale), tph);
		_mm512_storeu_si512((__m512i*)(_dst1+ptr*dstScale) + 1, tpl);
