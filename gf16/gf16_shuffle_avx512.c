...
static HEDLEY_ALWAYS_INLINE void gf16_shuffle_muladd_x_avx512(
	...
	for(intptr_t ptr = -(intptr_t)len; ptr; ptr += sizeof(__m512i)*2) {
		__m512i tph = _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale));
		__m512i tpl = _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale) + 1);
...
static HEDLEY_ALWAYS_INLINE void gf16_shuffle2x_muladd_x_avx512(
	...
	for(intptr_t ptr = -(intptr_t)len; ptr; ptr += sizeof(__m512i)) {
		__m512i swapped, result = _mm512_loadu_si512((__m512i*)(_dst1+ptr*dstScale));
		...
		_mm512_storeu_si512((__m512i*)(_dst1+ptr*dstScale), result);
