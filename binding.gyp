{
  ...
  "targets": [
    ...
    },
    {
      ...
      "type": "static_library",
      "defines": ["NDEBUG"],
      "sources": ["gf64/gf64_region_avx512_arr.c", "gf64/gf64_invert_avx512.c", "gf64/gf64_mul_avx512.c", "gf64/gf64_square.c", "gf64/gf64_invert_ita.c", "gf64/gf64_additive_fft.c", "gf64/gf64_poly_mul_karatsuba.c", "gf64/gf64_subproduct.c", "gf64/gf64_barycentric.c", "gf64/gf64_mpe.c", "gf64/gf64_montgomery.c"],
      "include_dirs": ["gf64"],
      "conditions": [
        ['target_arch in "ia32 x64" and OS=="win"', {
          "msvs_settings": {
    ...
    {
      "target_name": "hasher_rvzbc",
      "type": "static_library",
      "defines": ["NDEBUG"],
      "sources": ["hasher/hasher_rvzbc.cpp"],
      "cflags!": ["-fno-omit-frame-pointer", "-fno-tree-vrp", "-fno-strict-aliasing"],
      "cxxflags!": ["-fno-omit-frame-pointer", "-fno-tree-vrp", "-fno-strict-aliasing"],
      "xcode_settings": {
        "OTHER_CFLAGS!": ["-fno-omit-frame-pointer", "-fno-tree-vrp", "-fno-strict-aliasing"],
      ...
      "conditions": [
        ['target_arch=="riscv64" and OS!="win"', {
          "variables": {"supports_zbkc%": "<!(<!(echo ${CXX_target:-${CXX:-c++}}) -MM -E hasher/hasher_rvzbc.cpp -march=rv64gc_zbkc 2>/dev/null || true)"},
          "conditions": [
            ['supports_zbkc!=""', {
              "cflags!": ["-march=native"],
              "cxxflags!": ["-march=native"],
        ...
        ['target_arch=="riscv32" and OS!="win"', {
          "variables": {"supports_zbkc%": "<!(<!(echo ${CXX_target:-${CXX:-c++}}) -MM -E hasher/hasher_rvzbc.cpp -march=rv32gc_zbkc 2>/dev/null || true)"},
          "conditions": [
            ['supports_zbkc!=""', {
              "cflags!": ["-march=native"],
              "cxxflags!": ["-march=native"],
