...
#define RI4(i0, i1, i2, i3, kr) \
	...
	__asm__(
		"ldp %w[cache0], %w[cache1], %[in0]\n"
		"ldp %[k0], %[k1], [%[kM]]\n"
		ROUND_F(IA, A, IB, IC, ID, "%w[cache0]", "k0", "lsr %[k0], %[k0], #32", 25, "ldp %w[cache2], %w[cache3], %[in2]")
		ROUND_F(ID, D, A, IB, IC, "%w[cache1]", "k0", "", 20, "")
		ROUND_F(IC, C, D, A, IB, "%w[cache2]", "k1", "lsr %[k1], %[k1], #32", 15, "ldp %w[cache4], %w[cache5], %[in4]")
	...
	: [in0]"Q"(_in[0]), [in2]"Q"(_in[2]), [in4]"Q"(_in[4]),
	...
	__asm__(
		ROUND_F(A, A, B, C, D, "%w[cache0]", "k0", "lsr %[k0], %[k0], #32", 25, "ldp %w[cache2], %w[cache3], %[in14]")
		ROUND_F(D, D, A, B, C, "%w[cache1]", "k0", "", 20, "")
	...
	: [in14]"Q"(_in[14]), [kM]"r"(md5_constants_aarch64),
